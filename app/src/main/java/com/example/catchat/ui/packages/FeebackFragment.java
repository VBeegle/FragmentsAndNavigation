...
public class FeebackFragment extends Fragment {
    ...
    private FeebackViewModel mViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        mViewModel =
                ViewModelProviders.of(this).get(FeebackViewModel.class);
        View root = inflater.inflate(R.layout.feeback_fragment, container, false);
